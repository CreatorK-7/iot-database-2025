...
-- 사용자에게 madang에게 madangDB를 사용할 수 있는 모든 권한 부여
...
revoke select on mandang.* from mandang@localhost;
revoke all privileges on mandang.* from mandang@localhost;
revoke all privileges on mandang.* from mandang@'%';
flush privileges;